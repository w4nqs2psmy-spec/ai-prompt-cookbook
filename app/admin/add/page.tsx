...
import { insertAdminPromptAction } from '@/app/actions/promptActions';
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <PromptForm
          onSubmit={insertAdminPromptAction}
          showProCheckbox
          submitLabel="Lisää prompti"
          successMessage="Prompti lisätty ja julkaistu!"
        />
      </div>
    </div>
  );
