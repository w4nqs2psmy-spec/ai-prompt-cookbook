...
import { insertAdminTipAction } from '@/app/actions/tipActions';

export default function AdminTipAddPage() {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <TipForm
          onSubmit={insertAdminTipAction}
          isAdmin={true}
          submitLabel="Lisää vinkki"
          successMessage="Vinkki lisätty ja julkaistu!"
        />
      </div>
    </div>
  );
